    ...
    .factory('actionImgShow', function($rootScope,$compile,$ionicBody,$ionicPlatform, $ionicHistory) {
        ...
        var fns = {
            showLargeImg: function(opts) {
                ...
                var	element = scope.element = $compile('<img-slide-large lar-imgs="larImgs" current-img="{{currentImg}}" save-image="saveImage(currentImg)" img-close="imgClose()"></img-slide-large>')(scope);
