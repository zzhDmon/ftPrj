angular.module('App')
.directive('videoContainer', function(appUtils,$timeout) {
    return {
        restrict: 'EA',
        // templateUrl: 'views/includes/directives/video/video.html',
        templateUrl: 'views/publicPage/videoPlayer/directiveVideo.html',
        scope: {
            source: '=',
            image:'='
        },
