angular.module('App').controller('perCenterCtl',function($myBusinessData,NimUtils,appUtils,enterViewLoad,$localStorage,$ionicScrollDelegate,$ionicModal,$ionicLoading,$timeout,$interval,$ionicHistory,$Factory,$scope,$state,$http,$rootScope){
	$scope.tabActiveName = 'fifthTab';
	$scope.statusData=appUtils.statusData;

	//弹窗导航 
	$ionicModal.fromTemplateUrl('perCenter_nav_modal', {
		scope: $scope,
	...
	// 实名弹窗
	$ionicModal.fromTemplateUrl('percenter_real_name_modal', {
        scope: $scope,
